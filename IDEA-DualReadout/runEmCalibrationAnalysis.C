...
AnalysisResults analyzeFile(const std::string& input_file, double theta) {
  ...
  TH1F* h_TotalS = new TH1F(ss_s_name.str().c_str(), ss_s_title.str().c_str(), 400, 0.0, 120000.0);
  ...
  for (size_t i = 0; i < nEvents; ++i) {
    ...
    float eventTotalS = Scounts;
    float eventTotalC = Ccounts;
 ...
 */
int runEmCalibrationAnalysis() {

  // Map of theta values (in degrees) to their corresponding filenames
  std::map<double, std::string> filesToAnalyze;
  filesToAnalyze[0.5] = "emcalibration_newrad/IDEA_o2_v01_phi0p5_theta0p5_newrad.root";
  filesToAnalyze[20.5] = "emcalibration_newrad/IDEA_o2_v01_phi0p5_theta20p5_newrad.root";
  filesToAnalyze[40.5] = "emcalibration_newrad/IDEA_o2_v01_phi0p5_theta40p5_newrad.root";
  filesToAnalyze[50.6] = "emcalibration_newrad/IDEA_o2_v01_phi0p5_theta50p5_newrad.root";
  filesToAnalyze[60.5] = "emcalibration_newrad/IDEA_o2_v01_phi0p5_theta60p5_newrad.root";
  filesToAnalyze[70.5] = "emcalibration_newrad/IDEA_o2_v01_phi0p5_theta70p5_newrad.root";
  ...
  grS->SetMinimum(75000);
  grS->SetMaximum(85000);
  ...
  if (pointIndex > 0) {
    ...
    TFile* outFile = new TFile("EmCalibrationGraphs.root", "RECREATE");
